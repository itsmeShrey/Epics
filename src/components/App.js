...
function App() { 
    ...
    const detail = [{
            ...
            https1: <a style={{color: "#1c0380"}} href = "https://www.amazon.in/gp/product/B07CTR1ND8/ref=as_li_tl?ie=UTF8&camp=3638&creative=24630&creativeASIN=B07CTR1ND8&linkCode=as2&tag=dps0d-21&linkId=5732d98c6f6da42ae19af91cfd6ed775"
            target = "_blank"
            rel = "noopener noreferrer" > Purchase on Amazon </a>,
            https2: <a style={{color: "#1c0380"}} href = "https://www.bighaat.com/"
            target = "_blank"
            ...
            youtube: <a style={{color: "#1c0380"}} href = "https://www.youtube.com/watch?v=WqQ4cF1km1Q"
            target = "_blank"
        ...
        },
        {
            ...
            link: "Here are the links from where you can purchase this pesticide :",
            https1: <a style={{color: "#1c0380"}} href = "https://www.agrowala.com/product/fungicides/indofil-m-45-1-kg"
            target = "_blank"
